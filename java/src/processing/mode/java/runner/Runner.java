  ...
  static private void checkLocalHost() throws SketchException {
    try {
      ...
      if (!address.getHostAddress().equals("127.0.0.1")) {
        System.err.println("Your computer is not properly mapping 'localhost' to '127.0.0.1',\nwhich prevents sketches from working properly because 'localhost' \nis needed to connect the PDE to your sketch while it's running.\nIf you don't recall making this change, or know how to fix it:");
